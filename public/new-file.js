...
class PageBuilder{
    ...
    handleSaveBtnClick(target){
        ...
        console.log(this.generateDomElementToObject(this.wrapper.querySelector('[data-component="wrapper"]')));
        this.jsonElement.innerHTML = JSON.stringify(this.generateDomElementToObject(this.wrapper.querySelector('[data-component="wrapper"]')));
    }
